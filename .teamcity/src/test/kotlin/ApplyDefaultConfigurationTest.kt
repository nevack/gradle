...
class ApplyDefaultConfigurationTest {
    ...
    fun expectedRunnerParam(daemon: String = "--daemon", extraParameters: String = "", os: Os = Os.LINUX): String {
        val linuxPaths = "-Porg.gradle.java.installations.paths=%linux.java8.oracle.64bit%,%linux.java11.openjdk.64bit%,%linux.java17.openjdk.64bit%,%linux.java18.openjdk.64bit%,%linux.java19.openjdk.64bit%,%linux.java8.openjdk.64bit%"
        val windowsPaths = "-Porg.gradle.java.installations.paths=%windows.java8.oracle.64bit%,%windows.java11.openjdk.64bit%,%windows.java17.openjdk.64bit%,%windows.java18.openjdk.64bit%,%windows.java19.openjdk.64bit%,%windows.java8.openjdk.64bit%"
