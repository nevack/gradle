...
class PerformanceTestBuildTypeTest {
    ...
    fun `create correct PerformanceTest build type`() {
        ...
        val expectedRunnerParams = listOf(
            ...
            "\"-Porg.gradle.java.installations.paths=%linux.java8.oracle.64bit%,%linux.java11.openjdk.64bit%,%linux.java17.openjdk.64bit%,%linux.java18.openjdk.64bit%,%linux.java19.openjdk.64bit%,%linux.java8.openjdk.64bit%\"",
